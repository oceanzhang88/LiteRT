// Contents of main_standalone_gpu.cc (now a copy of main_standalone_cpu.cc)
...
int main(int argc, char** argv) {
    ...
    if (platform_str == "android") {
        ...
        start_preprocess = std::chrono::high_resolution_clock::now(); //don't count image to AHB timing
