...
// --- NEW: Add AHB forward declaration for Android ---
#ifdef __ANDROID__
...
unsigned char* ResizeImage(const unsigned char* input_data, int input_width,
                           ...
                           /**
* @brief Extracts a rectangular sub-region from an image.
*
* @param in_data Pointer to the source image data (unsigned char).
* @param in_width Width of the source image.
* @param in_height Height of the source image.
* @param in_channels Number of channels in the source image.
* @param crop_x The starting x-coordinate of the crop.
* @param crop_y The starting y-coordinate of the crop.
* @param crop_width The width of the desired crop.
* @param crop_height The height of the desired crop.
* @return A new unsigned char buffer containing the cropped image data,
* or nullptr if allocation fails or crop dimensions are invalid.
...
#ifdef __ANDROID__
/**
 * @brief Allocates an AHardwareBuffer and copies the raw image data into it.
 * @param data Raw RGBA image data.
 * @param width Image width.
 * @param height Image height.
 * @return A new AHardwareBuffer handle, or nullptr on failure.
 */
AHardwareBuffer* CreateAhbFromImageData(const unsigned char* data, int width, int height);

/**
 * @brief Releases an AHardwareBuffer handle.
 */
