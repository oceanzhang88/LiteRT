...
#define LOAD_SYMBOL(name)                                                               \
    ...
    // --- Flag Parsing ---
    std::string accelerator_str = GetFlagValue(argc, argv, "--accelerator=", "npu"); // Default to NPU
    ...
    options.accelerator_name = accelerator_str.c_str(); // Use parsed accelerator
    ...
    std::cout << "TextEnhancer session initialized for " << options.accelerator_name << "." << std::endl;
